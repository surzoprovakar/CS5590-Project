...
def db_generatoor(mode):

    # Replica A
    if mode == 1:
        connA = sqlite3.connect('../with-trust/Replica_A.db')
    else:
        connA = sqlite3.connect('../without-trust/Replica_A.db')
    ...
    # Replica B
    if mode == 1:
        connB = sqlite3.connect('../with-trust/Replica_B.db')
    else:
        connB = sqlite3.connect('../without-trust/Replica_B.db')
    ...
    # Replica C
    if mode == 1:
        connC = sqlite3.connect('../with-trust/Replica_C.db')
    else:
        connC = sqlite3.connect('../without-trust/Replica_C.db')
    ...
    # Replica D
    if mode == 1:
        connD = sqlite3.connect('../with-trust/Replica_D.db')
    else:
        connD = sqlite3.connect('../without-trust/Replica_D.db')
